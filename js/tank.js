$(document).ready(function () {
  ...
  function main() {
    const canvas = $("#tank").get(0); // bind to the html element
    ...
    const position_height = -carHeight / 2;
    const position_length = carLength / 3;

    const position_1_width = -carWidth / 2 - wheelThickness / 2;
    const position_2_width = carWidth / 2 + wheelThickness / 2;

    const wheelPositions = [
      [position_1_width, position_height, position_length],
      [position_2_width, position_height, position_length],
      [position_1_width, position_height, 0],
      [position_2_width, position_height, 0],
      [position_1_width, position_height, -position_length],
      [position_2_width, position_height, -position_length],
    ];
